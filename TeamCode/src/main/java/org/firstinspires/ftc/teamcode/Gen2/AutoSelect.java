        ...
        super("Select an Auto Configuration", s -> {
            s.folder("Blue", z -> {
                z.folder("Close", l -> {
                    ...
                    l.add("3", Blue3Close::new);
                });
                z.folder("Far", a -> {
                    a.add("9", Blue9Far::new);
                    a.add("6", Blue6Far::new);
                    a.add("3", Blue3Far::new);
                });
            });
            s.folder("Red", z -> {
                z.folder("Close", l -> {
                    ...
                    l.add("3", Red3Close::new);
                });
                z.folder("Far", a -> {
                    a.add("9", AutoRed9Far::new);
                    a.add("6", AutoRed6Far::new);
                    a.add("3", AutoRed3Far::new);
                });
            });
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                ...
                break; case 1: if(!follower.isBusy()) {
                    follower.followPath(scorePreload, true);
                    setPathState(2);
                }
                break; case 2: if(!follower.isBusy()) {
                    follower.followPath(movingBackPath, true);
                    setPathState(-1);
                }
                break;
...
class Red3Close extends OpMode {
    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;
    ...
    private Path scorePreload, movingOffLinePath;
...
class Blue3Close extends OpMode {
