...
public class Gen0AutoRed extends OpMode {
    ...
    private final Pose startPose = new Pose(0, 78, Math.toRadians(0));

    private final Pose Shooting = new Pose(76, 80, Math.toRadians(-35));
    ...
    private Path scorePreload, posAgain;
    ...
    public void buildPaths() {
        ...
        posAgain = new Path(new BezierLine(Shooting, Shooting));
        posAgain.setLinearHeadingInterpolation(Shooting.getHeading(), Shooting.getHeading());
