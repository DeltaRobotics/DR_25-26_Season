...
@TeleOp(name = "Gen2TeleopSingle")
//@Disabled

public class Gen2TeleopSingle extends LinearOpMode {
...
//            }
            ...
            if(gamepad1.dpad_left && buttonDL){
                ...
                robot.PIDTurret.setI(robot.PIDTurret.getI() - 0.000001);
                //robot.PIDTurret.setD(robot.PIDTurret.getD() - 0.000001);
            ...
            if(gamepad1.dpad_down && button2DD){

                while(gamepad1.dpad_down && button2DD){
...
//            if(lifting){
//                robot.mecanumDrive(-gamepad1.right_stick_y, 0, 0, 1);
//                robot.display_state_Lifting();
//            }

            //shooting
            if(gamepad1.right_bumper && button2RB){

                while(gamepad1.right_bumper && button2RB){
            ...
            if(gamepad1.right_trigger > 0.5 && button2RT){
                robot.L_swingythingy.setPosition(robot.L_swingy_Thingy_Close);
                robot.R_swingythingy.setPosition(robot.R_swingy_Thingy_Close);
                robot.transfer.setPower(-1);
                robot.L_feeder.setPower(-1);
            ...
            //intaking
            if(gamepad1.left_bumper && button2LB){
            ...
            //Outtaking
            if(gamepad1.left_trigger > 0.5 && button2LT ){
...
//            //Lifting
//            if(gamepad1.start && gamepad1.dpad_up && button2DU){
//
//                robot.lifting();
//                lifting = true;
//
